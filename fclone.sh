...
echo "|▉▉▉▉▉▉▉▉▉▉▉▉|100%  拷贝完毕"
echo -e "▣▣▣▣▣▣▣正在执行同步▣▣▣▣▣▣▣\n"
fclone sync goog:{$link} goog:{$myid}/"$rootName" --drive-server-side-across-configs  --drive-use-trash=false --stats=1s --stats-one-line -vP --checkers=256 --transfers=320 --drive-pacer-min-sleep=1ms --check-first --min-size 10M --drive-use-trash=false --log-file=/root/gclone_log/"$rootName"'_copy1.txt'
echo "|▉▉▉▉▉▉▉▉▉▉▉▉|100%  同步完毕"
echo -e "▣▣▣▣▣▣▣正在执行查重▣▣▣▣▣▣▣\n"
